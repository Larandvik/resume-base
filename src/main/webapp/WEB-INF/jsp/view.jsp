...
<%@ page import="com.larandvik.webapp.model.TextSection" %>
<%@ page import="com.larandvik.webapp.util.HtmlUtil" %>
  ...
  <p>
    <c:forEach var="contactEntry" items="${resume.contacts}">
      <jsp:useBean id="contactEntry"
                   type="java.util.Map.Entry<com.larandvik.webapp.model.ContactType, java.lang.String>"/>
  ...
  <table cellpadding="2">
    <c:forEach var="sectionEntry" items="${resume.sections}">
      <jsp:useBean id="sectionEntry"
                   type="java.util.Map.Entry<com.larandvik.webapp.model.SectionType, com.larandvik.webapp.model.Section>"/>
        ...
        <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
          <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>">
            ...
            <c:forEach var="position" items="${org.positions}">
              <jsp:useBean id="position" type="com.larandvik.webapp.model.Organization.Position"/>
              <tr>
